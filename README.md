...
- Pull requests: propose one branch into another, discuss it, see its commits and diff, and merge it from the browser (a real merge commit, computed in the bare repository and refused on conflicts)

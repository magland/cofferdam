...
export function defaultActionCacheDir(): string {
  ...
  return path.join(base, 'feorge', 'actions');
}
...
export class ActionStore {
  ...
  constructor(
    ...
    private forgeUrl: string = process.env.FEORGE_ACTIONS_URL ?? 'https://github.com',
    ...
    private useCache: boolean = process.env.FEORGE_ACTIONS_NO_CACHE !== '1'
  ) {}
  ...
  async resolve(
    ...
    const stamp = path.join(dest, '.feorge-fetched');

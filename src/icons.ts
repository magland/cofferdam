...
const PATHS: Record<string, string> = {
  ...
  'eye-off':
    '<path d="M2.5 12S6 5.5 12 5.5c1.6 0 3 .4 4.3 1.1M20 8.5c.9 1.9 1.5 3.5 1.5 3.5S18 18.5 12 18.5c-1.6 0-3-.4-4.3-1.1"/><path d="M9.9 14.1a2.8 2.8 0 0 1 4-4"/><path d="M4 20 20 4"/>',
